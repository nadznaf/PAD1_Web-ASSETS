...
@section('content')
    <div class="bg-white">
        ...
        <div class="flex justify-center mt-32 px-8">
            <img src="{{ asset('assets/assets_logo.svg') }}" class="w-434 h-103" alt="Assets Logo" data-aos="zoom-in-up" data-aos-duration="3000">
        </div>
        ...
        <div class="bg-assets py-16 px-8 md:px-32 mt-16">
            <h2 class="m-4 text-4xl font-bold text-white text-center" data-aos="fade-up" data-aos-duration="800">Aspirasi</h2>
            <p class="text-white text-center font-semibold text-lg" data-aos="fade-up" data-aos-duration="800">Suarakan Aspirasimu</p>
            <p class="text-white text-center text-base" data-aos="fade-up" data-aos-duration="800">Tuliskan pesan yang membangun dan dapat bermanfaat bagi perkembangan ASSETS. Pastikan pesan tidak mengandung SARA.</p>
            <div class=" bg-white rounded-2xl shadow-lg mx-auto my-16 p-8" data-aos="fade-up" data-aos-duration="800">
                ...
                <form action="{{ route('aspirasi.store') }}" id="uploadForm" method="POST" enctype="multipart/form-data" class="space-y-5">
                    @csrf
                    <div>
                        <label for="nama_pengirim" class="block text-base font-semibold text-assets mb-2">Nama Pengirim</label>
                    ...
                    <div>
                        <label for="judul_aspirasi" class="block text-base font-semibold text-assets mb-2">Judul Aspirasi</label>
                    ...
                    <div>
                        <label for="isi_aspirasi" class="block text-base font-semibold text-assets mb-2">Isi Aspirasi</label>
                    ...
                    <div class="flex justify-end space-x-4">
                        <button type="submit" class="text-white bg-assets hover:bg-second_a font-medium rounded-lg text-sm px-5 py-2.5">Kirim Aspirasi</button>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    @if ($index >= 6)
                        <div class="group flex flex-col bg-bg_aspiration border-2 border-border_aspiration hover:bg-second_a shadow-md rounded-xl">
                            <div class="p-4 md:p-7">
                                ...
                                <p class="mt-4 text-black group-hover:text-white text-center font-light align-middle items-center">
                                    "{{ $aspirasi->isi_aspirasi }}"
                                </p>
                            </div>
                        </div>
