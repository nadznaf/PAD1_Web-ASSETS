...
<div class="bg-white">
    ...
    <div id="warnaKabinet" class=" p-8 md:p-16 text-center">
        <h2 class="mt-2 text-3xl md:text-4xl font-bold text-white uppercase" data-aos="fade-down" data-aos-duration="1000">Kabinet {{ $kabinet->nama_kabinet ?? 'Nama Kabinet Tidak Diketahui'}}</h2>
        <p class="mt-4 md:mt-6 text-base md:text-lg font-normal text-white" data-aos="fade-down" data-aos-duration="1000">{{ $kabinet->deskripsi_kabinet ?? "Deskripsi Kabinet Tidak Tersedia"}}</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mx-8 lg:mx-24 my-16">
        ...
        <div class="flex flex-col justify-center space-y-6 mx-0 my-8 lg:m-4" data-aos="fade-left" data-aos-duration="1000">
            <div class="flex items-start">
                <div id="warnaKabinet" class="w-6 h-6 rounded-full mr-4"></div>
                <div>
                    <h3 class="text-xl font-semibold text-dark">Makna Kabinet</h3>
                    <p class="font-light text-dark mt-4">{{ $kabinet->makna_kabinet ?? 'Makna Kabinet Tidak Tersedia' }}</p>
                </div>
            </div>
            <div class="flex items-start">
                <div id="warnaKabinet" class="w-6 h-6 rounded-full mr-4"></div>
                <div>
                    ...
                    <p class="font-light text-dark mt-4">{{ $kabinet->visi_kabinet ?? 'Visi Kabinet Tidak Tersedia' }}</p>
                </div>
            </div>
            <div class="flex items-start">
                <div id="warnaKabinet" class="w-6 h-6 rounded-full mr-4"></div>
                <div>
                    ...
                    <p class="font-light text-dark mt-4">{{ $kabinet->misi_kabinet ?? 'Misi Kabinet Tidak Tersedia' }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="text-center mt-32 mb-8 mx-6 md:mx-auto" data-aos="fade-down" data-aos-duration="1000">
        ...
        <p class="mt-4 md:mt-6 text-base md:text-lg font-normal text-description">{{ $kabinet->deskripsi_kabinet ?? 'Deskripsi Divisi Tidak Tersedia' }}</p>
    </div>
    ...
    @if(isset($pengurusHarian) && count($pengurusHarian) > 0)
        <div class="hs-carousel w-full h-full overflow-hidden rounded-lg p-0">
                <div class="hs-carousel-body relative top-0 bottom-0 start-0 flex justify-center flex-nowrap opacity-0 cursor-grab transition-transform duration-700 hs-carousel-dragging:transition-none hs-carousel-dragging:cursor-grabbing" data-aos="fade-up" data-aos-duration="1000">
                    @if (isset($pengurusHarian['Ketua']))
                    <a href="{{ route('mahasiswa', $pengurusHarian['Ketua']->mahasiswa->id_mhs) }}">
                        <div class="hs-carousel-slide flex justify-center px-1 object-cover" data-modal-target="default-modal" data-modal-toggle="default-modal">
                            <figure
    ...
    {{-- proker kabinet --}}
    <div class="text-center mt-40 mx-6 md:mx-auto max-w-2xl lg:max-w-4xl" data-aos="fade-down" data-aos-duration="1000">
    ...
    <div class="grid grid-cols-1 justify-items-center gap-6 mx-8 mt-16 mb-40 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="max-w-sm justify-center hover:bg-bg_aspiration duration-100 rounded-lg shadow-lg" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="bg-black px-8 md:px-16 pt-8 pb-32 md:pt-24 text-center">
        <div class="mx-auto mt-8 mb-16 md:mb-24 max-w-2xl lg:max-w-4xl" data-aos="fade-down" data-aos-duration="1000">
    ...
    @else
        <div class="text-center my-16">
            ...
            <p class="text-gray-500 mt-4">Silakan periksa kembali data atau hubungi administrator jika masalah berlanjut.</p>
        </div>
    @endif
</div>
