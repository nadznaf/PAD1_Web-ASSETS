...
<div class="bg-white">
    ...
    <div class="flex justify-center my-32 px-8 md:my-40">
        <img src="{{ asset('storage/datakabinet/' . $kabinet->logo_kabinet) }}" class="w-434 h-103 object-fit" alt="Kabinet Logo" data-aos="zoom-in" data-aos-duration="1000">
    </div>

    {{-- ketua --}}
    <div class="grid grid-cols-3 justify-between">
        <div class="grid grid-cols-1 bg-gradient-to-r from-[var(--primary-color)] to-white px-0 md:px-32 py-8 gap-8"></div>
        <h2 id="teksWarnaKabinet" class="text-2xl grid grid-col-1 font-extralight md:text-5xl lg:text-7xl text-center items-center" data-aos="fade-down" data-aos-duration="800">Ketua</h2>
    ...
    <a href="{{ route('mahasiswa', $pengurusHarian['Ketua']->mahasiswa->id_mhs) }}">
        <div class="group flex flex-col items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="group flex flex-col justify-between p-4 leading-normal md:w-2/3">
                <h5 id="teksWarnaKabinet" class="mb-2 text-2xl md:text-4xl font-semibold group-hover:text-dark">{{ $pengurusHarian['Ketua']->mahasiswa->nama_mhs }}</h5>
    ...
    <a href="{{ route('mahasiswa', $pengurusHarian['Sekretaris Jenderal']->mahasiswa->id_mhs) }}">
        <div class="flex flex-col-reverse items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row" data-aos="fade-left" data-aos-duration="1000">
    ...
    <div class="grid grid-cols-3 justify-between pt-16">
        <div class="grid grid-cols-1 bg-gradient-to-r from-[var(--primary-color)] to-white px-0 md:px-32 py-8 gap-8"></div>
        <h2 id="teksWarnaKabinet" class="text-2xl grid grid-col-1 font-extralight md:text-5xl lg:text-7xl text-center items-center" data-aos="fade-down" data-aos-duration="800">Sekretaris</h2>
        <div class="grid grid-col-1 bg-gradient-to-l from-[var(--primary-color)] to-white px-0 md:px-32 py-8 gap-8"></div>
    </div>
    @if (isset($pengurusHarian['Sekretaris I']))
    <a href="{{ route('mahasiswa', $pengurusHarian['Sekretaris I']->mahasiswa->id_mhs) }}">
        <div class="flex flex-col items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row" data-aos="fade-right" data-aos-duration="1000">
    ...
    <a href="{{ route('mahasiswa', $pengurusHarian['Sekretaris II']->mahasiswa->id_mhs) }}">
        <div class="flex flex-col-reverse items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row" data-aos="fade-left" data-aos-duration="1000">
            <div class="flex flex-col justify-between p-4 leading-normal md:w-2/3">
    ...
    <div class="grid grid-cols-3 justify-between pt-16">
        <div class="grid grid-cols-1 bg-gradient-to-r from-[var(--primary-color)] to-white px-0 md:px-32 py-8 gap-8"></div>
        <h2 id="teksWarnaKabinet" class="text-2xl grid grid-col-1 font-extralight md:text-5xl lg:text-7xl text-center items-center" data-aos="fade-down" data-aos-duration="800">Bendahara</h2>
        <div class="grid grid-col-1 bg-gradient-to-l from-[var(--primary-color)] to-white px-0 md:px-32 py-8 gap-8"></div>
    </div>
    @if (isset($pengurusHarian['Bendahara I']))
    <a href="{{ route('mahasiswa', $pengurusHarian['Bendahara I']->mahasiswa->id_mhs) }}">
        <div class="flex flex-col items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row" data-aos="fade-right" data-aos-duration="1000">
    ...
    <a href="{{ route('mahasiswa', $pengurusHarian['Bendahara II']->mahasiswa->id_mhs) }}">
        <div class="flex flex-col-reverse items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row" data-aos="fade-left" data-aos-duration="1000">
            <div class="flex flex-col justify-between p-4 leading-normal md:w-2/3">
    ...
    <div class="grid grid-cols-3 justify-between pt-16">
        <div class="grid grid-cols-1 bg-gradient-to-r from-[var(--primary-color)] to-white px-0 md:px-32 py-8 gap-8"></div>
        <h2 id="teksWarnaKabinet" class="text-2xl grid grid-col-1 font-extralight md:text-5xl lg:text-7xl text-center items-center" data-aos="fade-down" data-aos-duration="800">Divisi</h2>
        <div class="grid grid-col-1 bg-gradient-to-l from-[var(--primary-color)] to-white px-0 md:px-32 py-8 gap-8"></div>
    </div>
    ...
    @if ($divisi->nama_divisi == "Pengurus Harian")
        ...
        @continue
    @endif
    <div class="text-center mt-32 mx-6 md:mx-auto max-w-2xl lg:max-w-4xl" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="flex min-h-full items-center justify-center overflow-x-hidden px-4 py-8 bg-black">
        <div class="flex justify-center gap-1 px-4 overflow-y-hidden">
            <div class="order-last flex w-max items-center justify-center gap-1" data-aos="fade-up" data-aos-duration="1000">
                @foreach ($divisi->staff as $staff)
                @if ($staff->nama_jabatan =='Kepala Divisi')
                    <a href="{{ route('mahasiswa', $staff->mahasiswa->id_mhs) }}">
                        <div class="group relative order-first w-16 lg:w-80 overflow-hidden transition-all duration-500 peer-hover:w-20 hover:w-80">
                            <div class="h-80 md:h-96">
                                <img class="h-full w-full rounded-lg object-cover transition-transform duration-500 peer-hover:scale-75" src="{{ asset('storage/datastaff/' . $staff->foto_pose_staff) }}" alt="" />
                            </div>
                            <div class="flex w-full md:w-80 xl:w-96 justify-between px-2 pt-2">
                                <div class="relative">
                                    <span class="absolute -left-2 m-auto block text-sm tracking-wide text-gray-600 transition duration-300 group-hover:invisible group-hover:opacity-0">Kadiv</span>
                                    <h2 class="leading-0 opacity-0 font-medium text-gray-700 transition duration-300 group-hover:opacity-100">{{ $staff->mahasiswa->nama_mhs }}</h2>
                                </div>
                ...
                @elseif ($staff->nama_jabatan =='Wakil Kepala Divisi')
                    <a href="{{ route('mahasiswa', $staff->mahasiswa->id_mhs) }}">
                        <div class="peer group relative w-16 lg:w-20 overflow-hidden transition-all duration-500 hover:w-80">
                            <div class="h-80 md:h-96">
                                <img class="h-full w-full rounded-lg object-cover" src="{{ asset('storage/datastaff/' . $staff->foto_pose_staff) }}" alt="" />
                            </div>
                            <div class="flex w-full md:w-80 xl:w-96 justify-between px-2 pt-2">
                                <div class="relative">
                                    ...
                                    <h2 class="leading-0 font-medium text-gray-700 opacity-0 transition duration-300 group-hover:opacity-100">{{ $staff->mahasiswa->nama_mhs }}</h2>
                                </div>
                    ...
                    @foreach ($divisi->proker as $proker)
                        <a href="{{ route('proker.show', $divisi->id_divisi) }}">
                            <div class="group flex justify-between items-center">
                                <p class="text-black uppercase group-hover:text-font">{{ $proker->judul_proker }}</p>
                                <div
