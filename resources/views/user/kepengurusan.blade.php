...
<div class="bg-white">
    ...
    <div class="mb-24 mx-4 md:mx-32 p-4 md:p-16 text-center">
        <h2 class="mt-2 text-4xl md:text-4xl font-bold text-black uppercase">Kepengurusan amara 2024</h2>
    ...
    {{-- spesifik kabinet --}}
    <div class="bg-amara grid xs:grid-rows-3 px-16 py-8 justify-items-center lg:px-32 lg:grid-cols-3 lg:gap-8 ">
    ...
    {{-- logo kabinet --}}
    <div class="flex justify-center my-32 px-8">
    ...
    <div class="grid grid-cols-3 justify-between">
        ...
        <h2 class="text-2xl grid grid-col-1 font-extralight text-amara md:text-7xl text-center">Ketua</h2>
        <div class="grid grid-col-1 bg-gradient-to-l from-amara to-white px-0 md:px-32 py-8 gap-8"></div>
    </div>
    <div class="flex flex-col items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row hover:bg-gray-100" data-modal-target="default-modal" data-modal-toggle="default-modal">
        <img class="object-cover w-full h-96 rounded-lg md:mr-8 md:w-1/2" src="{{ asset('assets/yodhim.svg') }}" alt="Ketua">
        <div class="flex flex-col justify-between p-4 leading-normal">
            <h5 class="mb-2 text-xl md:text-4xl font-semibold text-amara">Yodhimas Geffananda</h5>
    ...
    <div class="flex flex-col-reverse items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row hover:bg-gray-100" data-modal-target="default-modal" data-modal-toggle="default-modal">
        <div class="flex flex-col justify-between p-4 leading-normal">
            <h5 class="mb-2 text-xl md:text-4xl font-semibold text-amara">Rioga Natayudha</h5>
    ...
    <div class="grid grid-cols-3 justify-between mt-4">
        <div class="grid grid-cols-1 bg-gradient-to-r from-amara to-white px-0 md:px-32 py-8 gap-8"></div>
        <h2 class="text-2xl grid grid-col-1 font-extralight text-amara md:text-7xl text-center">Sekretaris</h2>
        <div class="grid grid-col-1 bg-gradient-to-l from-amara to-white px-0 md:px-32 py-8 gap-8"></div>
    </div>
    <div class="flex flex-col items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row hover:bg-gray-100" data-modal-target="default-modal" data-modal-toggle="default-modal">
        <img class="object-cover w-full h-96 rounded-lg md:mr-8 md:w-1/2" src="{{ asset('assets/risma.svg') }}" alt="Ketua">
        <div class="flex flex-col justify-between p-4 leading-normal">
            <h5 class="mb-2 text-xl md:text-4xl font-semibold text-amara">Risma Saputri</h5>
    ...
    <div class="flex flex-col-reverse items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row hover:bg-gray-100" data-modal-target="default-modal" data-modal-toggle="default-modal">
        <div class="flex flex-col justify-between p-4 leading-normal">
            <h5 class="mb-2 text-xl md:text-4xl font-semibold text-amara">Charizza Thunjung</h5>
    ...
    <div class="grid grid-cols-3 justify-between mt-4">
        ...
        <h2 class="text-2xl grid grid-col-1 font-extralight text-amara md:text-7xl text-center">Bendahara</h2>
    ...
    <div class="flex flex-col items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row hover:bg-gray-100" data-modal-target="default-modal" data-modal-toggle="default-modal">
        ...
        <div class="flex flex-col justify-between p-4 leading-normal">
            <h5 class="mb-2 text-xl md:text-4xl font-semibold text-amara">Luthfi Lisana S</h5>
    ...
    <div class="flex flex-col-reverse items-center mx-8 md:mx-16 my-16 bg-white rounded-lg md:flex-row hover:bg-gray-100" data-modal-target="default-modal" data-modal-toggle="default-modal">
        <div class="flex flex-col justify-between p-4 leading-normal">
            <h5 class="mb-2 text-xl md:text-4xl font-semibold text-amara">Marwah Kamila A</h5>
    ...
    <div class="grid grid-cols-3 justify-between mt-4">
        <div class="grid grid-cols-1 bg-gradient-to-r from-amara to-white md:px-32 py-8 gap-8"></div>
        <h2 class="text-2xl grid grid-col-1 font-extralight text-amara md:text-7xl text-center">Divisi</h2>
        <div class="grid grid-col-1 bg-gradient-to-l from-amara to-white md:px-32 py-8 gap-8"></div>
    </div>

    {{-- divisi psdm --}}
    <div class="text-center mt-48 mx-6 md:mx-auto max-w-2xl lg:max-w-4xl">
    ...
    <div class="flex min-h-full items-center justify-center overflow-x-hidden px-1 py-8 bg-black">
        <div class="group/list flex justify-center gap-1">
          <div class="peer order-last flex w-max items-center justify-center gap-1">
            <div class="group relative w-20 overflow-hidden transition-all duration-500 hover:w-96" data-modal-target="default-modal" data-modal-toggle="default-modal">
              <div class="h-96">
            ...
            <div class="group relative w-20 overflow-hidden transition-all duration-500 hover:w-96" data-modal-target="default-modal" data-modal-toggle="default-modal">
              ...
              <div class="flex w-96 justify-between px-2 pt-2">
                <div class="relative">
                  <span class="absolute -left-2 m-auto block text-sm tracking-wide text-gray-600 transition duration-300 group-hover:invisible group-hover:opacity-0">Anggota</span>
                  <h2 class="leading-0 font-medium text-gray-700 opacity-0 transition duration-300 group-hover:opacity-100">Yodhimas Geffananda</h2>
                </div>
                <span class="text-sm tracking-wide text-gray-600">Anggota</span>
              </div>
            </div>
            <div class="group relative w-20 overflow-hidden transition-all duration-500 hover:w-96" data-modal-target="default-modal" data-modal-toggle="default-modal">
              <div class="h-96">
          ...
          <div class="group relative order-first w-96 overflow-hidden transition-all duration-500 hover:w-96 peer-hover:w-20" data-modal-target="default-modal" data-modal-toggle="default-modal">
            <div class="h-96">
              <img class="h-full w-full rounded-lg object-cover" src="{{ asset('assets/yodhim.svg') }}" alt="" />
            </div>
            <div class="flex w-96 justify-between px-2 pt-2">
              <div class="relative">
                <span class="absolute -left-2 m-auto block text-sm tracking-wide text-gray-600 transition-opacity duration-300 opacity-0 group-hover:opacity-0 group-hover/list:opacity-100">Kadiv</span>
                <h2 class="leading-0 group-hover/list:opacity-0 font-medium text-gray-700 transition duration-300 group-hover:opacity-100">Yodhimas Geffananda</h2>
              </div>
    ...
    {{-- divisi psdm --}}
    <div class="text-center mt-48 mx-6 md:mx-auto max-w-2xl lg:max-w-4xl">
        <h2 class="mt-2 text-2xl md:text-4xl font-semibold text-black uppercase">medkraf</h2>
        <p class="mt-4 md:mt-6 mb-8 text-base md:text-lg font-normal text-amara">Media Kreatif</p>
    </div>
    <div class="flex min-h-full items-center justify-center overflow-x-hidden px-1 py-8 bg-black">
        <div class="group/list flex justify-center gap-1">
          <div class="peer order-last flex w-max items-center justify-center gap-1">
