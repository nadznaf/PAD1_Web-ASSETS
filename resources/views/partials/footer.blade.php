...
<footer id="footer" class="{{ request()->routeIs('kabinet.show') ? 'bg-amara': 'bg-assets'}}">
    ...
    <div class="container px-6 py-8 mx-auto w-full">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            ...
            <div class="flex">
                <a href="https://mail.google.com/mail/u/0/?hl=en&tf=cm&fs=1&to=assets.ugm@gmail.com" class="mx-4" aria-label="Email">
                ...
                <a href="https://www.instagram.com/assets_ugm" class="mx-4" aria-label="Instagram">
                    <div class="group rounded-full p-2 bg-white hover:bg-dark hover:duration-75">
                        <svg class="w-15 h-15 text-dark group-hover:text-white hover:duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <a href="https://www.facebook.com/share/Q8ocoXcgkDKVXDTc/" class="mx-4" aria-label="Facebook" target="">
                    <div class="group rounded-full p-2 bg-white hover:bg-dark hover:duration-75">
                        <svg class="w-15 h-15 text-dark group-hover:text-white hover:duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
