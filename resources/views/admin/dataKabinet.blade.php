        ...
        <tbody id="TableBody">
          ...
          <tr>
            ...
            <td class="text-center">
              <img src="{{ asset('storage/datakabinet/' . $kabinet->logo_kabinet) }}" class="rounded w-24 h-24 object-cover">
            </td>
            <td>
                        ...
                        <form action="{{ route('admin.datakabinet.update', $kabinet->id_kabinet) }}" id="editForm" enctype="multipart/form-data" method="POST" novalidate>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label>Logo Kabinet</label><br>
                                    <div class="d-flex flex-column align-items-center">
                                        <div id="image-preview-edit-{{$dataKabinet->firstItem() + $index }}" class="border border-gray-400 border-dashed rounded-lg mb-3 p-3"
                                            style="width: 200px; height: 200px; display: flex; justify-content: center; align-items: center; cursor: pointer;"
                                        ...
                                        <input type="file" name="logoKabinet" id="editInput-{{$dataKabinet->firstItem() + $index }}" accept="image/*" class="form-control" style="display: none;">
                                        <button type="button" class="btn btn-danger mt-2" id="clear-button-edit-{{$dataKabinet->firstItem() + $index }}">Clear Image</button>
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                      <!-- Image preview will appear here -->
                                        <div id="image-preview-edit2-{{$dataKabinet->firstItem() + $index }}" class="border border-gray-400 border-dashed rounded-lg mb-3 p-3"
                                            style="width: 200px; height: 200px; display: flex; justify-content: center; align-items: center; cursor: pointer;"
                                        ...
                                        <input type="file" name="fotoSampulKabinet" id="editInput2-{{$dataKabinet->firstItem() + $index }}" accept="image/*" class="form-control" style="display: none;">
                                        <button type="button" class="btn btn-danger mt-2" id="clear-button-edit2-{{$dataKabinet->firstItem() + $index }}">Clear Image</button>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
