      ...
      <div class="modal fade" id="insertData" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{route("admin.datakabinet.store")}}" id="uploadForm" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            @csrf
              <div class="modal-body">
                <label for="namaKabinet">Nama Kabinet</label><br>
                <input type="text" name="namaKabinet" placeholder="Tuliskan nama kabinet" class="form-control"
                  required>
                ...
                <div class="d-flex flex-column align-items-center">
                    <div id="image-preview2" class="border border-gray-400 border-dashed rounded-lg mb-3 p-3"
                    ...
                    <input type="file" name="logoKabinet" id="uploadInput2" accept="image/*" class="form-control" style="display: none;">
                    <button type="button" class="btn btn-danger mt-2" id="clear-button2" style="display: none;">
                        Clear Image
                    </button>
                </div>
                <div class="invalid-feedback">
                ...
                <input type="text" name="visiKabinet" placeholder="Tuliskan visi kabinet" class="form-control"
                  required>
                <div class="invalid-feedback">
                ...
                <input type="text" name="misiKabinet" placeholder="Tuliskan misi kabinet" class="form-control"
                  required>
                <div class="invalid-feedback">
                ...
                <input type="text" name="maknaKabinet" placeholder="Tuliskan makna kabinet" class="form-control">
                <div class="invalid-feedback">
                ...
                <input type="number" name="tahunAwalKabinet" placeholder="Masukkan hanya tahunnya saja" class="form-control"
                  required>
                <div class="invalid-feedback">
                ...
                <input type="number" name="tahunAkhirKabinet" placeholder="Masukkan hanya tahunnya saja" class="form-control"
                  required>
                <div class="invalid-feedback">
                ...
                <div class="d-flex flex-column align-items-center">
                    ...
                    <input type="file" name="fotoKabinet" id="uploadInput" accept="image/*" class="form-control" style="display: none;">
    ...
    <div class="table-responsive">
      <table class="table table-bordered equal-width-table">
        ...
        <tbody id="TableBody">
          ...
          <tr>
            ...
            <td class="text-center">
              <img src="{{ asset('storage/datakabinet/' . $kabinet->logo_kabinet) }}" class="rounded w-24 h-24">
            </td>
            <td>
            ...
            <td>
              <div class="action-buttons">
                <button type="button" class="btn w-100" id="buttonedit" data-bs-toggle="modal" data-bs-target="#editModal{{ $kabinet->id_kabinet }}">
                  Edit
                </button>
                <button type="button" class="btn w-100" id="buttonred" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $kabinet->id_kabinet}}">
                  Delete
                </button>
              </div>
            </td>
        ...
        <!-- Modal delete mahasiswa -->
            <div class="modal fade" id="deleteModal{{ $kabinet->id_kabinet }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $kabinet->id_kabinet }}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="deleteModalLabel{{ $kabinet->id_kabinet }}">Hapus Data Kabinet</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                            <form action="{{ route('admin.datakabinet.destroy', $kabinet->id_kabinet) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
          ...
          <!-- Edit Modal -->
            <div class="modal fade" id="editModal{{ $kabinet->id_kabinet }}" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ route('admin.datakabinet.update', $kabinet->id_kabinet) }}" id="editForm" enctype="multipart/form-data" method="POST" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="namaKabinet" value="{{ $kabinet->nama_kabinet }}">
                                </div>
                                <div class="mb-3">
                                    <label>Logo Kabinet</label><br>
                                    <div class="d-flex flex-column align-items-center">
                                        <div id="image-preview-edit" class="border border-gray-400 border-dashed rounded-lg mb-3 p-3"
                                            style="width: 200px; height: 200px; display: flex; justify-content: center; align-items: center; cursor: pointer;"
                                            onclick="document.getElementById('editInput').click();">
                                            <img src="{{ asset('storage/datakabinet/' . $kabinet->logo_kabinet) }}" class="rounded" style="object-fit: cover; max-width: 100%; max-height: 100%;">
                                        </div>
                                        <input type="file" name="logoKabinet" id="editInput" accept="image/*" class="form-control" style="display: none;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="visiKabinet" value="{{ $kabinet->visi_kabinet }}">
                                </div>
                                <div class="mb-3">
                                    <label for="misiKabinet" class="form-label">Misi Kabinet</label>
                                    <input type="text" class="form-control" name="misiKabinet" value="{{ $kabinet->misi_kabinet }}">
                                </div>
                                <div class="mb-3">
                                    <label for="maknaKabinet" class="form-label">Makna Kabinet</label>
                                    <input type="text" class="form-control" name="maknaKabinet" value="{{ $kabinet->makna_kabinet }}">
                                </div>
                                <div class="mb-3">
                                    <label for="deskripsiKabinet">Deskripsi Kabinet</label><br>
                                    <textarea id="deskripsiKabinet" name="deskripsiKabinet" class="form-control" value="{{ $kabinet->deskripsi_kabinet }}" style="resize: none;" rows="4" cols="50">{{ $kabinet->deskripsi_kabinet }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="id_dosen">Dosen Pebimbing</label><br>
                                    <select name="id_dosen" class="form-select" required>
                                ...
                                <div class="mb-3">
                                    <label for="tahunAwalKabinet">Tahun Mulai Kabinet</label><br>
                                    <input type="number" name="tahunAwalKabinet" class="form-control" value="{{ $kabinet->tahun_awal_kabinet }}" >
                                </div>
                                <div class="mb-3">
                                    <label for="tahunAkhirKabinet">Tahun Selesai Kabinet</label><br>
                                ...
                                <div class="mb-3">
                                    <label>Foto Sampul Kabinet</label><br>
                                    <div class="d-flex flex-column align-items-center">
                                        <div id="image-preview-edit2" class="border border-gray-400 border-dashed rounded-lg mb-3 p-3"
                                            style="width: 200px; height: 200px; display: flex; justify-content: center; align-items: center; cursor: pointer;"
                                            onclick="document.getElementById('editInput2').click();">
                                            <img src="{{ asset('storage/datakabinet/' . $kabinet->foto_sampul_kabinet) }}" class="rounded" style="object-fit: cover; max-width: 100%; max-height: 100%;">
                                        </div>
                                        <input type="file" name="fotoSampulKabinet" id="editInput2" accept="image/*" class="form-control" style="display: none;">
                                        <button type="button" class="btn btn-danger mt-2" id="clear-button-edit2">Clear Image</button>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
...
<div class="d-flex justify-content-center">
  <nav aria-label="Page navigation">
    <ul class="pagination">
      ...
      @else
        <li class="page-item">
          <a class="page-link" href="{{ $dataKabinet->previousPageUrl() }}" rel="prev">&laquo; Previous</a>
        </li>
      @endif
...
document.getElementById('editInput2').addEventListener('change', function(event) {
    const imagePreviewEdit = document.getElementById('image-preview-edit2');
    const clearButtonEdit = document.getElementById('clear-button-edit2');
...
document.getElementById('clear-button-edit2').addEventListener('click', function() {
    const imagePreviewEdit = document.getElementById('image-preview-edit2');
    const uploadInputEdit = document.getElementById('editInput2');
