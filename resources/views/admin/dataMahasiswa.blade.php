          ...
          <div class="modal-content">
            ...
            <!-- Modal Body -->
              <div class="modal-body">
                ...
                <input type="text" name="nimMahasiswa" placeholder="Tuliskan NIM mahasiswa" class="form-control"
                  required>
                <div class="invalid-feedback">
    ...
    <div class="table-responsive">
      <table class="table table-bordered">
        ...
        <!-- Modal delete mahasiswa -->
            <div class="modal fade" id="deleteModal{{ $mahasiswa->id_mhs }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $mahasiswa->id_mhs }}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="deleteModalLabel{{ $mahasiswa->id_mhs }}">Hapus Data Mahasiswa</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                            <form action="{{ route('admin.datamahasiswa.destroy', $mahasiswa->id_mhs) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
          ...
          <!-- Edit Modal -->
            <div class="modal fade" id="editModal{{ $mahasiswa->id_mhs }}" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ route('admin.datamahasiswa.update', $mahasiswa->id_mhs) }}" id="editForm" enctype="multipart/form-data" method="POST" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="namaMhs" value="{{ $mahasiswa->nama_mhs }}">
                                </div>
                                <div class="mb-3">
                                    <label for="nimMhs" class="form-label">Nomor Induk Mahasiswa (NIM)</label>
                                    <input type="text" class="form-control" name="nimMhs" value="{{ $mahasiswa->nim_mhs }}">
                                </div>
                                <div class="mb-3">
                                    <label>Foto Profil Mahasiswa</label><br>
                                    <div class="d-flex flex-column align-items-center">
...
<div class="d-flex justify-content-center">
  <nav aria-label="Page navigation">
    <ul class="pagination">
      ...
      @else
        <li class="page-item">
          <a class="page-link" href="{{ $dataMahasiswa->previousPageUrl() }}" rel="prev">&laquo; Previous</a>
        </li>
      @endif
